# Cafe24 주문상세 파일 상태 조회 안내 박스 스니펫

- 작성 기준: 2026-07-06
- 대상 화면: Cafe24 주문상세 화면
- 문서 성격: 스마트디자인 삽입 전 검토용 HTML/CSS 스니펫

## 1. 문서 목적

이 문서는 Cafe24 주문상세 화면에서 고객이 업로드 파일 상태 조회 페이지로 이동할 수 있도록 안내 박스를 추가하기 위한 검토용 스니펫입니다.
...
- Cafe24 주문상세 화면의 주문 상품 정보 영역 근처
...
주문상세 화면이 좁거나 안내 문구가 길게 느껴질 경우 아래 문구로 줄일 수 있습니다.
...
- 주문상세 화면에서 업로드 파일 ID가 고객에게 보이는지 확인합니다.
